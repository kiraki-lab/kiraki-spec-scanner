(function () {
  ...
  const presets = [
    ...
    { id: 'sapphire-video-40k-normal-will-hilla-v01', name: '4만점 Lv.281 노멀 윌·노멀 진 힐라형 (하드 윌 제외)', type: 'hunting', tierId: 'sapphire', level: 281, bossIds: [...fortyKBase, 'will-normal', 'verus-hilla-normal'], status: 'reference', summary: 'Lv.281 + 포함: 노멀 윌, 노멀 진 힐라 (제외: 하드 윌)', note: '하드 윌을 잡지 않는 대신 노멀 윌과 노멀 진 힐라를 잡는 루트입니다. 사용자가 준 41,000점 빌드 기준입니다.' },
    { id: 'sapphire-video-40k-normal-will-no-hilla-v01', name: '4만점 Lv.282 노멀 윌형 (하드 윌 제외)', type: 'hunting', tierId: 'sapphire', level: 282, bossIds: [...fortyKBase, 'will-normal'], status: 'reference', summary: 'Lv.282 + 포함: 노멀 윌 (제외: 하드 윌·진 힐라)', note: '노멀 윌을 포함하고 하드 윌은 제외하는 루트입니다. 진 힐라는 노멀·하드 모두 제외하고, 3,000점 이하 나머지 보스는 완료 기준입니다. 총 40,500점.' },
  ...
  window.CHALLENGERS_DATA = { version: '0.8.3', levelMissions, bossMissions, tiers, buildTypes, presets };
})();