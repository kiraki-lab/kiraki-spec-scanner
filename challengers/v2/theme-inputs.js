...
.input-hub-grid.single-progress-grid{grid-template-columns:minmax(250px,.82fr) minmax(320px,1.18fr)}
...
@media(max-width:980px){.input-hub-grid{grid-template-columns:1fr 1fr}.result-input-card{grid-column:1/-1}.single-progress-grid .result-input-card{grid-column:auto}.boss-filter-panel{grid-template-columns:minmax(0,1fr) 180px}.boss-expand-actions{grid-column:1/-1;justify-content:flex-end}}
@media(max-width:700px){.header-inner{flex-direction:column;align-items:stretch}.header-actions{width:100%;align-items:stretch;flex-wrap:wrap;justify-content:flex-start}.theme-toggle{min-width:128px}.input-hub{padding:15px}.input-hub-heading{flex-direction:column}.input-hub-utilities{width:100%;justify-content:space-between}.input-hub-grid,.input-hub-grid.single-progress-grid{grid-template-columns:1fr}.result-input-card,.single-progress-grid .result-input-card{grid-column:auto}.boss-filter-panel{grid-template-columns:1fr}.boss-expand-actions{grid-column:auto;display:grid;grid-template-columns:1fr 1fr}.profile-input-row{grid-template-columns:1fr}.profile-input-row .button{width:100%}}
