...
- 공개 모드: 비밀번호 없이 수동 계산 가능. 가격이나 항목 데이터는 저장하지 않습니다.
- 멤버십 모드: `0722` 입력. 수동 가격 저장, 가격 JSON 가져오기/내보내기 가능.
- 관리자 모드: `0322` 입력. 수동 가격 저장, 항목 수정, 항목 JSON 가져오기/내보내기 가능.
...
- 브라우저 로컬 저장: 멤버십/관리자 모드에서 입력한 임시 가격과 항목 수정본
